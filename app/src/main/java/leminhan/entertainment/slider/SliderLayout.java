package leminhan.entertainment.slider;
...
import leminhan.entertainment.slider.Animations.BaseAnimationInterface;
import leminhan.entertainment.slider.Indicators.PagerIndicator;
import leminhan.entertainment.slider.SliderTypes.BaseSliderView;
import leminhan.entertainment.slider.Transformers.AccordionTransformer;
import leminhan.entertainment.slider.Transformers.BackgroundToForegroundTransformer;
import leminhan.entertainment.slider.Transformers.BaseTransformer;
import leminhan.entertainment.slider.Transformers.CubeInTransformer;
import leminhan.entertainment.slider.Transformers.DefaultTransformer;
import leminhan.entertainment.slider.Transformers.DepthPageTransformer;
import leminhan.entertainment.slider.Transformers.FadeTransformer;
import leminhan.entertainment.slider.Transformers.FlipHorizontalTransformer;
import leminhan.entertainment.slider.Transformers.FlipPageViewTransformer;
import leminhan.entertainment.slider.Transformers.ForegroundToBackgroundTransformer;
import leminhan.entertainment.slider.Transformers.RotateDownTransformer;
import leminhan.entertainment.slider.Transformers.RotateUpTransformer;
import leminhan.entertainment.slider.Transformers.StackTransformer;
import leminhan.entertainment.slider.Transformers.TabletTransformer;
import leminhan.entertainment.slider.Transformers.ZoomInTransformer;
import leminhan.entertainment.slider.Transformers.ZoomOutSlideTransformer;
import leminhan.entertainment.slider.Transformers.ZoomOutTransformer;
import leminhan.entertainment.slider.Tricks.FixedSpeedScroller;
import leminhan.entertainment.slider.Tricks.InfinitePagerAdapter;
import leminhan.entertainment.slider.Tricks.InfiniteViewPager;
