...
public class TongHopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it_back = new Intent(TongHopActivity.this, MovieActivity.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TruyenHinhQuocTeFragment(), "HÀI KỊCH");
        adapter.addFragment(new KenhPhoBienFragment(), "CẢI LƯƠNG");
