...
public class ThieuNhiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it_back = new Intent(ThieuNhiActivity.this, MovieActivity.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TruyenHinhQuocTeFragment(), "HOẠT HÌNH");
        adapter.addFragment(new KenhPhoBienFragment(), "ÂM NHẠC");
        adapter.addFragment(new KenhTheThaoFragment(), "CHƠI MÀ HỌC");
        adapter.addFragment(new KenhPhimTruyenFragment(), "TIẾNG ANH");
