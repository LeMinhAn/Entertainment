...
import leminhan.entertainment.adapter.KenhGiaiTriTongHopAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhGiaiTriTongHopFragment extends Fragment {
    GridView gv;
    ...
    public KenhGiaiTriTongHopFragment() {
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhGiaiTriTongHopAdapter(getActivity(), prgmNameList, prgmImages));
