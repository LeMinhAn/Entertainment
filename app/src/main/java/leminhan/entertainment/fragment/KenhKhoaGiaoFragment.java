...
import leminhan.entertainment.adapter.KenhKhoaGiaoAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhKhoaGiaoFragment extends Fragment {
    GridView gv;
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhKhoaGiaoAdapter(getActivity(), prgmNameList, prgmImages));
