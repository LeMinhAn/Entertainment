...
import leminhan.entertainment.adapter.KenhPhimTruyenAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhPhimTruyenFragment extends Fragment {
    GridView gv;
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhPhimTruyenAdapter(getActivity(), prgmNameList, prgmImages));
