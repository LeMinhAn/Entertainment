 ...
 */
public class TruyenHinhQuocTeFragment extends Fragment {
    GridView gv;
    ...
    public TruyenHinhQuocTeFragment() {
    ...
    private void initView() {
        ...
        gv.setAdapter(new TruyenHinhQuocTeAdapter(getActivity(), prgmNameList, prgmImages));
