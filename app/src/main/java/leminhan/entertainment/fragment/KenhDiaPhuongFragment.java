...
import leminhan.entertainment.adapter.KenhDiaPhuongAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhDiaPhuongFragment extends Fragment {
    GridView gv;
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhDiaPhuongAdapter(getActivity(), prgmNameList, prgmImages));
