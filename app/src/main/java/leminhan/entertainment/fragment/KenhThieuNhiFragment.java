...
import leminhan.entertainment.adapter.KenhThieuNhiAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhThieuNhiFragment extends Fragment {
    GridView gv;
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhThieuNhiAdapter(getActivity(), prgmNameList, prgmImages));
