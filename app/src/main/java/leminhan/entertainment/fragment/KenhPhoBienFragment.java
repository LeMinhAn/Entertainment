...
import leminhan.entertainment.adapter.KenhPhoBienAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhPhoBienFragment extends Fragment {
    GridView gv;
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhPhoBienAdapter(getActivity(), prgmNameList, prgmImages));
