...
import leminhan.entertainment.adapter.KenhTheThaoAdapter;

/**
 * Created by Le Minh An on 8/8/2016.
 */
public class KenhTheThaoFragment extends Fragment {
    GridView gv;
    ...
    private void initView() {
        ...
        gv.setAdapter(new KenhTheThaoAdapter(getActivity(), prgmNameList, prgmImages));
