...
public class TVShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it_back = new Intent(TVShowActivity.this, MovieActivity.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TruyenHinhQuocTeFragment(), "TRUYỀN HÌNH THỰC TẾ");
        adapter.addFragment(new KenhPhoBienFragment(), "TRÒ CHƠI TRUYỀN HÌNH");
        adapter.addFragment(new KenhTheThaoFragment(), "ĐÀM LUẬN");
